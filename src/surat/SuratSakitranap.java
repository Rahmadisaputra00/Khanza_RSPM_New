 ...
 * @author salimmulyana
 */
public final class SuratSakitranap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SuratSakitranap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void MnCetakSuratSakitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSakitActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                Valid.MyReportqry("rptSuratSakitranap.jasper","report","::[ Surat Sakit ]::",
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratSakitranap dialog = new SuratSakitranap(new javax.swing.JFrame(), true);
