...
public final class SuratKeteranganDokter extends javax.swing.JDialog {
    ...
    public SuratKeteranganDokter(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Surat","No.Rawat","No.R.M.","Nama Pasien","Tanggal","Kesimpulan"
        }){
    ...
    private void initComponents() {
        ...
        TPasien.setBounds(335, 10, 270, 23);
        ...
        TanggalSurat.setBounds(80, 70, 100, 23);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,NoSurat,"costum_surat_keterangan_dokter","no_surat")==true){
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            tgl=" costum_surat_keterangan_dokter.tanggalsurat between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
            if(TCari.getText().trim().equals("")){
                ...
                Valid.MyReportqry("rptDataSuratKeteranganSehat.jasper","report","::[ Data Surat Keterangan Sehat ]::",
                     "select costum_surat_keterangan_dokter.no_surat,costum_surat_keterangan_dokter.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "costum_surat_keterangan_dokter.tanggalawal,costum_surat_keterangan_dokter.tanggalakhir "+                  
                     "from costum_surat_keterangan_dokter inner join reg_periksa on costum_surat_keterangan_dokter.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     ...
                     tgl+"and costum_surat_keterangan_dokter.tanggalakhir like '%"+TCari.getText().trim()+"%' "+
                     "order by costum_surat_keterangan_dokter.no_surat",param);
            }
    ...
    */
        ...
        try{
            ...
            if(TCari.getText().trim().equals("")){
                ...
                ps=koneksi.prepareStatement(
                     ...
                     tgl+"and reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and costum_surat_keterangan_dokter.tanggalsurat like '%"+TCari.getText().trim()+"%' "+
                     "order by costum_surat_keterangan_dokter.no_surat");
            }
    ...
    public void isCek(){
//        BtnSimpan.setEnabled(akses.getcostum_surat_keterangan_dokter());
//        BtnHapus.setEnabled(akses.getcostum_surat_keterangan_dokter());
//        BtnEdit.setEnabled(akses.getcostum_surat_keterangan_dokter());
    }
}
